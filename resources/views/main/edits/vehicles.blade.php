        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <form action="{{ route('vehicles.update', $vehicle->id_vehicle) }}" method="POST" class="form"
                    ...
                    <ul class="row" id="box">
                        <li class="col-lg-6" id="inputs">
                            <input id="input" type="text" name="name" placeholder="Nome" required
                                pattern="^[a-zA-Z0-9\s]+$" title="Apenas letras, números e espaços são permitidos"
                                value="{{ $vehicle->name }}">
                    ...
                    <ul class="row" id="box">
                        <li class="col-lg-6" id="inputs">
                            <input id="input" type="number" name="mileage" step="0.01" min="0.00" placeholder="Km"
                                required pattern="^[a-zA-Z0-9\s]+$"
                                title="Apenas números, virgulas e pontos são permitidos"
