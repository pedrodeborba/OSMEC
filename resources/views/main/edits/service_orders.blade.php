                ...
                <form action="{{ route('service_orders.update', $service_order->id_service_order) }}" method="POST" class="form"
                    ...
                    <ul class="row" id="box">
                        <li class="col-lg" id="inputs">
                            <input id="input" type="text" name="defect" placeholder="Defeito" value="{{ $service_order->defect }}" required >
                        </li>
                    </ul>

                    <ul class="row" id="box">
                        <li class="col-lg" id="inputs">
                            <input id="input" type="text" name="solution" placeholder="Solução" value="{{ $service_order->solution }}" required>
                        </li>
                    </ul>

                    <ul class="row" id="box">
                        <li class="col-lg" id="inputs">
                            <input id="input" type="number" name="work_price" placeholder="Mão de Obra (R$)" value="{{ $service_order->work_price }}" required>
                        </li>
                    </ul>
                    ...
                    <ul class="row" id="box">
                        ...
                        <li class="col-lg" id="inputs">
                            <input id="input" type="date" name="entry_date" placeholder="DD/MM/AAAA" value="{{ $service_order->entry_date }}" required>
                        </li>
                    </ul>
                    ...
                    <ul class="row" id="box">
                        ...
                        <li class="col-lg" id="inputs">
                            <input id="input" type="date" name="exit_date" placeholder="Data de conclusão: DD/MM/AAAA" value="{{ $service_order->exit_date }}" required>
                        </li>
                    </ul>
                    ...
                    <ul class="row" id="box">
                        ...
                        <li class="col-lg-6 text-end" id="inputs">
                            ...
                            <a href="{{ route('service_orders.index') }}"><button type="button"
