                ...
                <div class="table-box">
                    <table class="table table-striped">
                        <thead>
                            ...
                            <th class="table-column">Perfil</th>
                        ...
                        <tbody>
                            @foreach($mechanics as $mechanic)
                                <tr>
                                    ...
                                    <td class="table-column">
                                        <a href="{{ route('mechanics.delete', $mechanic->id_person) }}">
                                            <button class="icons">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><span>Perfil: </span>
                                    <p>{{ $mechanic->profile }}</p>
                                </li>
                                <li class="list-group-item"><span>Especialidade: </span>
                                    <p>{{ $mechanic->specialty }}</p>
                                </li>
